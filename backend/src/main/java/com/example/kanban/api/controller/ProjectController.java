...
public class ProjectController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid transition or date conflict (message provides adjustment advice)."),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid input or data validation failure."),
            @ApiResponse(responseCode = "404", description = "One or more Responsible IDs were not found.")
    })
    @PostMapping
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid input or data validation failure."),
            @ApiResponse(responseCode = "404", description = "Project or Responsible not found."),
    })
    @PutMapping("/{id}")
